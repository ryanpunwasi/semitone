      ...
      <div className='container'>
        ...
        <div className='row'>
          <div className='col-lg-6 col-md-12 mx-auto mallanna mb-3'>
            <p>Hello there and welcome!  The goal of this application is to hone your ability to distinguish between various pitches. To begin, select any one of the training modes below.</p>
          </div>
        </div>
        </div>
      <div className='container'>
